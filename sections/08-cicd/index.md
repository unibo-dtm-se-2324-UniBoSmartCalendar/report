...
![Pipeline Architecture Diagram](cipipelinediagram.png)

## 8.3. CD Implementation: Vercel Integration

While GitHub Actions handles the _Integration_ (verification), **Vercel** handles the _Delivery_ (deployment).
